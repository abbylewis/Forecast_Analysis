...
Papers per year
```{r}
complete_forecasts <- read.csv("complete_dataset_with_source.csv") #Load data
...
jpeg("Pubs_year_noEco.jpeg", width = 3, height = 3, units = "in",res = 600)
complete_forecasts%>%
  ggplot()+
...
Map
```{r}
complete_forecasts <- read.csv("complete_dataset_with_source.csv")
...
library(ggpubr)
jpeg("Map_composite.jpeg",width = 6, height = 5.5, units = "in", res = 600)
...
jpeg("best_practices_regression.jpg",res = 600,width = 6, height = 5, units = "in")
plot = prob_df%>%
...
jpeg("Years_of_data.jpeg", res = 600, width = 3, height = 3, units = "in")
complete_forecasts%>%
...
jpeg("timestep_heatmap.jpeg",res = 600,width = 6, height = 4, units = "in")
...
jpeg("timestep_heatmap_small.jpeg",res = 600,width = 3, height = 3, units = "in")
library("RColorBrewer")
cols <- brewer.pal(n = 9, name = "BuPu")
time_bin_plot%>%
  ggplot(aes(x = horiz_bin, y = time_bin), na.rm = T)+
