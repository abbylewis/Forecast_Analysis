...
Section 10: Forecast evaluation statistics. Note: the percentage of papers that do not evaluate forecasts that predict at a horizon of at least one year is presented in section 5 above
...
#Statistics for the percent of papers that use R2 are in the R2 analysis code file
```
...
sum(grepl("persistence",complete_forecasts$Null_type, ignore.case = T))/sum(complete_forecasts$Null_yn)
#Percentage of papers that use a climatology null model
sum(grepl("climatology",complete_forecasts$Null_type, ignore.case = T))/sum(complete_forecasts$Null_yn)
