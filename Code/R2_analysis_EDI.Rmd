...
length(unique(r2s$Title[!is.na(r2s$R2_value)]))
length(unique(r2s$Title[!is.na(r2s$R2_value)]))/sum(complete_forecasts$Forecast_eval_shown)*100
...
set.seed(47)
summary(model, se = "boot", bsmethod= "wild") 
