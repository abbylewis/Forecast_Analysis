...
Note: Every code chunk can be rund individually to perform the specified task.
...
Section 9: Calculate statistics for the type of uncertainty used
...
Section 13: Calculate statistics for uncertainty partitioning
Section 14: Calculate statistics for forecast archiving
Section 15: Calculate statistics for null model use
...
tiff("../Figures/best_practices_regression.tif",res = 800,width = 6, height = 5, units = "in", compression="lzw")
plot = prob_df%>%
